...
if game:GetService("CoreGui"):FindFirstChild("POWERx") then
    game:GetService("CoreGui"):FindFirstChild("POWERx"):Destroy()
end
...
local POWERx = Instance.new("ScreenGui")
POWERx.Name = "POWERx"
POWERx.Parent = game.CoreGui
POWERx.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
...
function Flux:Window(text, bottom,mainclr,toclose)
	...
	PresetColor = mainclr or Color3.fromRGB(235, 64, 52)
	local fs = false
	...
	BottomText.Size = UDim2.new(0, 113, 0, 40)
	...
	function Flux:Notification(desc,buttontitle)
		...
		CloseBtn.BackgroundColor3 = Color3.fromRGB(43, 43, 43)
	...
	function Tabs:Tab(text,ico)
		...
		function ContainerContent:Colorpicker(text,preset,callback)
			...
			Confirm.BackgroundColor3 = Color3.fromRGB(43, 43, 43)
		...
		function ContainerContent:Bind(text,presetbind,callback)
			...
			Title.Font = Enum.Font.Gotham
			Title.Text = text
			Title.TextColor3 = Color3.fromRGB(244, 165, 252)
			Title.TextSize = 15.000
			Title.TextTransparency = 0.300
			Title.TextXAlignment = Enum.TextXAlignment.Left
